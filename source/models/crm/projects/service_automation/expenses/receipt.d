...
class DAPLExpenseReceipt : DOOPEntity {
  this() { super();
    this.attributes([
      ...
      "expenseReceiptId": OOPAttributeUUID.descriptions(["en":"Unique identifier for entity instances"]),
      "stateCode": OOPAttributeString.descriptions(["en":"Status of the Expense Receipt"]),
      "stateCode_display": OOPAttributeString.descriptions(["en":""]),
      "statusCode": OOPAttributeString.descriptions(["en":"Reason for the status of the Expense Receipt"]),
      "statusCode_display": OOPAttributeString.descriptions(["en":""]),
      "expenseId": OOPAttributeUUID.descriptions(["en":"Shows the ID of the expense entry."]),
    ]);
  }
