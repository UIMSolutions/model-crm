  ...
  override void initialize() {
    ...
    this
      .addValues([
        ...
        "actualDeliveryOn": OOPTimestampAttribute.descriptions(["en":"Enter the date when the invoiced product was delivered to the customer."]),
        ...
        "isCopied": OOPBooleanAttribute.descriptions(["en":"Select whether the invoice product is copied from another item or data source."]),
        "isPriceOverridden": OOPBooleanAttribute.descriptions(["en":"Select whether the price per unit is fixed at the value in the specified price list or can be overridden by users who have edit rights to the invoice product."]),
        "isProductOverridden": OOPBooleanAttribute.descriptions(["en":"Select whether the product exists in the Microsoft Dynamics 365 product catalog or is a write-in product specific to the parent invoice."]),
        "lineItemNumber": OOPIntegerAttribute.descriptions(["en":"Type the line item number for the invoice product to easily identify the product in the invoice and make sure it's listed in the correct order."]),
        ...
        "shippingTrackingNumber": OOPIntegerAttribute.descriptions(["en":"Type a tracking number for shipment of the invoiced product."]),
