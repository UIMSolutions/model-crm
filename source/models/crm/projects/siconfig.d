...
class DAPLSiconfig : DOOPEntity {
  this() { super();
    this.attributes([
      ...
      "siConfigId": OOPAttributeUUID.descriptions(["en":"Unique identifier for entity instances"]),
      "stateCode": OOPAttributeString.descriptions(["en":"Status of the siconfig"]),
      "stateCode_display": OOPAttributeString.descriptions(["en":""]),
      "statusCode": OOPAttributeString.descriptions(["en":"Reason for the status of the siconfig"]),
      "statusCode_display": OOPAttributeString.descriptions(["en":""]),
      "version": OOPAttributeString.descriptions(["en":"The name of the custom entity."]),
    ]);
  }
