...
class DAPLOrderClose : DOOPEntity {
  this() { super();
    this.attributes([
      ...
      "stateCode": OOPAttributeString.descriptions(["en":"Shows whether the order close activity is open, completed, or canceled. By default, order close activities are completed."]),
      "stateCode_display": OOPAttributeString.descriptions(["en":""]),
      "statusCode": OOPAttributeString.descriptions(["en":"Reason for the status of the order close activity."]),
      ...
      "serviceId": OOPAttributeUUID.descriptions(["en":"Unique identifier of the service with which the order close activity is associated."]),
      "orderNumber": OOPAttributeNumber.descriptions(["en":"Order number."]),
      "revision": OOPAttributeString.descriptions(["en":"Order revision number."]),
      "salesOrderId": OOPAttributeUUID.descriptions(["en":"Unique identifier of the order with which the order close activity is associated."]),
      "salesOrderIdType": OOPAttributeString.descriptions(["en":"The name of the entity linked by salesOrderId"]),
  ...
  override string entityClass() { return "aplOrderClose"; }
  override string entityClasses() { return "aplOrderCloses"; }
...
auto APLOrderClose() { return new DAPLOrderClose; } 
auto APLOrderClose(Json json) { return new DAPLOrderClose(json); } 
