  ...
  override void initialize() {
    ...
    this
      .addValues([
        ...
        "billToAddressId": UUIDAttributeClass, // address").descriptions(["en":"Unique identifier of the billing address."]),
        ...
        "discountPercentage": PercentageAttributeClass, // Type the discount rate that should be applied to the Detail Amount field to include additional savings for the customer in the order."]),
        ...
        "SLAId": UUIDAttributeClass, // aplSLA").descriptions(["en":"Choose the service level agreement (SLA) that you want to apply to the sales order record."]),
