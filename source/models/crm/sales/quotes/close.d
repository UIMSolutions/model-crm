...
class DAPLQuoteClose : DOOPEntity {
  this() { super();
    this.attributes([
      ...
      "stateCode": OOPAttributeString.descriptions(["en":"Shows whether the quote close activity is open, completed, or canceled. By default, quote close activities are completed."]),
      "stateCode_display": OOPAttributeString.descriptions(["en":""]),
      "statusCode": OOPAttributeString.descriptions(["en":"Reason for the status of the quote close activity."]),
      ...
      "serviceId": OOPAttributeUUID.descriptions(["en":"Unique identifier of the service with which the quote close activity is associated."]),
      "quoteId": OOPAttributeUUID.descriptions(["en":"Unique identifier of the quote with which the quote close activity is associated."]),
      "quoteIdType": OOPAttributeString.descriptions(["en":"The name of the entity linked by quoteId"]),
      "quoteNumber": OOPAttributeNumber.descriptions(["en":"Quote number."]),
      "revision": OOPAttributeString.descriptions(["en":"Quote revision number."]),
