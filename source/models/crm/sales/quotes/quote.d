  ...
  override void initialize() {
    ...
    this
      .addValues([
        ...
        "discountPercentage": PercentageAttributeClass, // Type the discount rate that should be applied to the Detail Amount field to include additional savings for the customer in the quote."]),
        ...
        "SLAId": UUIDAttributeClass, // aplSLA").descriptions(["en":"Choose the service level agreement (SLA) that you want to apply to the quote record."]),
