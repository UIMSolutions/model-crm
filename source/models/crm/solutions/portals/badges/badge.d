module models.crm.solutions.portals.badges.badge;

@safe:
import uim.entities;

// 
class DAPLBadge : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLBadge() { return new DAPLBadge; } 
auto APLBadge(Json json) { return new DAPLBadge(json); } 

unittest {
  version(uim_entities) {
    assert(APLBadge);
  
  auto entity = APLBadge;
