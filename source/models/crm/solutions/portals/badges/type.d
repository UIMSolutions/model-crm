module models.crm.solutions.portals.badges.type;

@safe:
import uim.entities;

// 
class DAPLBadgeType : DOOPEntity {
  this() { super();
    this.attributes([
  ...
  override string entityClass() { return "aplBadgeType"; }
  override string entityClasses() { return "aplBadgeTypes"; }
...
auto APLBadgeType() { return new DAPLBadgeType; } 
auto APLBadgeType(Json json) { return new DAPLBadgeType(json); } 

unittest {
  version(uim_entities) {
    assert(APLBadgeType);
  
  auto entity = APLBadgeType;
