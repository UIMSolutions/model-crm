module models.crm.solutions.portals.blogs.post;

@safe:
import uim.entities;

// A post belonging to a portal blog.
class DAPLBlogPost : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLBlogPost() { return new DAPLBlogPost; } 
auto APLBlogPost(Json json) { return new DAPLBlogPost(json); } 

unittest {
  version(uim_entities) {
    assert(APLBlogPost);
  
  auto entity = APLBlogPost;
