module models.crm.solutions.portals.cases.case_;

@safe:
import uim.entities;

// Service request case associated with a contract.
class DAPLCase : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLCase() { return new DAPLCase; } 
auto APLCase(Json json) { return new DAPLCase(json); } 
