module models.crm.solutions.portals.cases.deflection;

@safe:
import uim.entities;

// Captures the number of Found My Answer clicks in the portal.
class DAPLCaseDeflection : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLCaseDeflection() { return new DAPLCaseDeflection; } 
auto APLCaseDeflection(Json json) { return new DAPLCaseDeflection(json); } 

unittest {
  version(uim_entities) {
    assert(APLCaseDeflection);
  
  auto entity = APLCaseDeflection;
