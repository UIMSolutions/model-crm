module models.crm.solutions.portals.forums.forum;

@safe:
import uim.entities;

// 
class DAPLForum : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLForum() { return new DAPLForum; } 
auto APLForum(Json json) { return new DAPLForum(json); } 

unittest {
  version(uim_entities) {
    assert(APLForum);
  
  auto entity = APLForum;
