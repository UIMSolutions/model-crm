module models.crm.solutions.portals.forums.post;

@safe:
import uim.entities;

// 
class DAPLForumPost : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLForumPost() { return new DAPLForumPost; } 
auto APLForumPost(Json json) { return new DAPLForumPost(json); } 

unittest {
  version(uim_entities) {
    assert(APLForumPost);
  
  auto entity = APLForumPost;
