module models.crm.solutions.portals.forums.thread;

@safe:
import uim.entities;

// 
class DAPLForumThread : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLForumThread() { return new DAPLForumThread; } 
auto APLForumThread(Json json) { return new DAPLForumThread(json); } 

unittest {
  version(uim_entities) {
    assert(APLForumThread);
  
  auto entity = APLForumThread;
