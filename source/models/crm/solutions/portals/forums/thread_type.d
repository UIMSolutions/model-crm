module models.crm.solutions.portals.forums.thread_type;

@safe:
import uim.entities;

// 
class DAPLForumThreadType : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLForumThreadType() { return new DAPLForumThreadType; } 
auto APLForumThreadType(Json json) { return new DAPLForumThreadType(json); } 

unittest {
  version(uim_entities) {
    assert(APLForumThreadType);
  
  auto entity = APLForumThreadType;
