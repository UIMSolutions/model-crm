module models.crm.solutions.portals.ideas.forum;

@safe:
import uim.entities;

// The root entity for portal Ideas.
class DAPLIdeaForum : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLIdeaForum() { return new DAPLIdeaForum; } 
auto APLIdeaForum(Json json) { return new DAPLIdeaForum(json); } 

unittest {
  version(uim_entities) {
    assert(APLIdeaForum);
  
  auto entity = APLIdeaForum;
