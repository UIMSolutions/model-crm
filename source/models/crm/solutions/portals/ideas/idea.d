module models.crm.solutions.portals.ideas.idea;

@safe:
import uim.entities;

// An idea belonging to a portal Idea Forum.
class DAPLIdea : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLIdea() { return new DAPLIdea; } 
auto APLIdea(Json json) { return new DAPLIdea(json); } 
