module models.crm.solutions.portals.polls.option;

@safe:
import uim.entities;

// 
class DAPLPollOption : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLPollOption() { return new DAPLPollOption; } 
auto APLPollOption(Json json) { return new DAPLPollOption(json); } 

unittest {
  version(uim_entities) {
    assert(APLPollOption);
  
  auto entity = APLPollOption;
