module models.crm.solutions.portals.polls.placement;

@safe:
import uim.entities;

// The root entity for portal Ideas.
class DAPLPollPlacement : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLPollPlacement() { return new DAPLPollPlacement; } 
auto APLPollPlacement(Json json) { return new DAPLPollPlacement(json); } 

unittest {
  version(uim_entities) {
    assert(APLPollPlacement);
  
  auto entity = APLPollPlacement;
