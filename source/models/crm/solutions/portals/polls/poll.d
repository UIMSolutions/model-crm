module models.crm.solutions.portals.polls.poll;

@safe:
import uim.entities;

// The root entity for portal Ideas.
class DAPLPoll : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLPoll() { return new DAPLPoll; } 
auto APLPoll(Json json) { return new DAPLPoll(json); } 
