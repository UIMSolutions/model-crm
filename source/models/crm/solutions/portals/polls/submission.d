module models.crm.solutions.portals.polls.submission;

@safe:
import uim.entities;

// The root entity for portal Ideas.
class DAPLPollSubmission : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLPollSubmission() { return new DAPLPollSubmission; } 
auto APLPollSubmission(Json json) { return new DAPLPollSubmission(json); } 

unittest {
  version(uim_entities) {
    assert(APLPollSubmission);
  
  auto entity = APLPollSubmission;
