module models.crm.solutions.portals.web.files.file;

@safe:
import uim.entities;

// Storage of files used in the web Portals.
class DAPLWebFile : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLWebFile() { return new DAPLWebFile; } 
auto APLWebFile(Json json) { return new DAPLWebFile(json); } 

unittest {
  version(uim_entities) {
    assert(APLWebFile);
  
  auto entity = APLWebFile;
