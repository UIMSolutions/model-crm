module models.crm.solutions.portals.web.files.log;

@safe:
import uim.entities;

// A record of the download of a web file
class DAPLWebFileLog : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLWebFileLog() { return new DAPLWebFileLog; } 
auto APLWebFileLog(Json json) { return new DAPLWebFileLog(json); } 

unittest {
  version(uim_entities) {
    assert(APLWebFileLog);
  
  auto entity = APLWebFileLog;
