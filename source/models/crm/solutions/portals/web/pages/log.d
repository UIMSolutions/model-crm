module models.crm.solutions.portals.web.pages.log;

@safe:
import uim.entities;

// A record of a user viewing a Web Page
class DAPLWebPageLog : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLWebPageLog() { return new DAPLWebPageLog; } 
auto APLWebPageLog(Json json) { return new DAPLWebPageLog(json); } 

unittest {
  version(uim_entities) {
    assert(APLWebPageLog);
  
  auto entity = APLWebPageLog;
