module models.crm.solutions.portals.web.pages.page;

@safe:
import uim.entities;

// WebPage 
class DAPLWebPage : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLWebPage() { return new DAPLWebPage; } 
auto APLWebPage(Json json) { return new DAPLWebPage(json); } 

unittest {
  version(uim_entities) {
    assert(APLWebPage);
  
  auto entity = APLWebPage;
