module models.crm.solutions.portals.web.role;

@safe:
import uim.entities;

// Sets the user's role for the Portal.
  class DAPLWebRole : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLWebRole() { return new DAPLWebRole; } 
auto APLWebRole(Json json) { return new DAPLWebRole(json); } 

unittest {
  version(uim_entities) {
    assert(APLWebRole);
  
  auto entity = APLWebRole;
