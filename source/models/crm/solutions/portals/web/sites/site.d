module models.crm.solutions.portals.web.sites.site;

@safe:
import uim.entities;

// Web Portal
  class DAPLWebSite : DOOPEntity {
  this() { super();
    this.attributes([
...
auto APLWebSite() { return new DAPLWebSite; } 
auto APLWebSite(Json json) { return new DAPLWebSite(json); } 

unittest {
  version(uim_entities) {
    assert(APLWebSite);
  
  auto entity = APLWebSite;
