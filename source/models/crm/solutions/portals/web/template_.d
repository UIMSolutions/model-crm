module models.crm.solutions.portals.web.template_;

@safe:
import uim.entities;

// 
class DAPLWebTemplate : DOOPEntity {
  this() { super();
    this.attributes([
  ...
  // mixin(GetEntity!("webSite", "webSiteId", "APLWebSite"));

}
auto APLWebTemplate() { return new DAPLWebTemplate; } 
auto APLWebTemplate(Json json) { return new DAPLWebTemplate(json); } 

unittest {
  version(uim_entities) {
    assert(APLWebTemplate);
  
  auto entity = APLWebTemplate;
